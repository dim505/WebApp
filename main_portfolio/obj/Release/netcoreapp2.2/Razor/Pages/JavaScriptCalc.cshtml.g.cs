#pragma checksum "C:\scratch\projects\WebApp\main_portfolio\Pages\JavaScriptCalc.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d16cee9c4b57bf8ce6f89473bc93d6d5e87e7318"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d16cee9c4b57bf8ce6f89473bc93d6d5e87e7318", @"/Pages/JavaScriptCalc.cshtml")]
...
<script>
    ...
    ");
            WriteLiteral(@"        //sets the displays value
            document.getElementById(""display"").value = display
    ...
    function btnSub() {
        ...
        if (display[display.length - 1] == ""+"" || display[display.length - 1] == ""-"" || display[display.length - 1] == ""/"" || display[display.length - 1] == ""*"") {
            //extracts the display minus the last sign pressed and adds the - sign ");
            WriteLiteral(@"incase the operation sign was pressed BEFORE
            display = display.slice(0, -1) + ""-""
    ...
    function btnAdd() {
        ...
        //checks to see if the the operation sign was pressed mutliple times
        if (display[display.length - 1] == ""+"" || display[display.length - 1] == ""-"" || display[display.length - 1] == ""/"" || display[display.length");
            WriteLiteral(@" - 1] == ""*"") {
    ...
    function btnDiv() {
        ...
        if (display[display.length - 1] == """);
            WriteLiteral(@"+"" || display[display.length - 1] == ""-"" || display[display.length - 1] == ""/"" || display[display.length - 1] == ""*"") {
            //extracts the display minus the last sign pressed and adds the - sign incase the operation sign was pressed BEFORE
            display = display.slice(0, -1) + ""/""
            //sets the displays value
            document.getElementById(""display"").value = display
...
<div class=""text-right"">
    ...
    <h2 cla");
            WriteLiteral(@"ss=""display-4 mb-0"">Here is my Javascript Calculator! </h2>
...
<div id=""containment"">
    ...
    <div id=""draggable"" class=""ui-widget-content"" data-toggle=""popover"" data-placement=""top"" data-content=""DRAG ME!!"" data-trigger=""hover"">
        ");
            EndContext();
            BeginContext(8130, 2459, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d16cee9c4b57bf8ce6f89473bc93d6d5e87e731811779", async() => {
                BeginContext(8136, 2446, true);
                WriteLiteral(@"
            <div>
                <table>
