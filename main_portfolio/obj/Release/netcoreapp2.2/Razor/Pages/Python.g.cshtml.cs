#pragma checksum "C:\Users\bob\Documents\Visual Studio 2015\Projects\razor_pages\WebApp\main_portfolio\Pages\Python.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "02f20601cd21babc1536431cecaf8fc5b495085d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"02f20601cd21babc1536431cecaf8fc5b495085d", @"/Pages/Python.cshtml")]
...
<div class=""AMS"">
    ...
    <p>
        ...
        non-italicized link that does not have a");
            WriteLiteral(@"ny external links or links to the current page. It will also show
...
def continue_crawl(Pages_visited, end_url):
    ...
    if Pages_visited[-1] == end_url:													
        print(""\n\nWe'v");
            WriteLiteral(@"e reached your specified target url - "" + end_url + ""\n"")
...
def Find_link(url):
	...
	html = response.text
	#cre");
            WriteLiteral(@"ates a BeautifulSoup object used for extracting data from the html 
...
#checks to see i");
            WriteLiteral(@"f it should contine checking for links
...
while continue_crawl(Pages_visited, end_url):
    ...
    <div id=""iframeContainer"">
        <iframe id=""youtube"" width=""100%"" height=""315"" src=""ht");
            WriteLiteral("tps://www.youtube.com/embed/rXGZ4QRBmpg\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>\r\n    </div>\r\n</div>\r\n");
            EndContext();
        }
