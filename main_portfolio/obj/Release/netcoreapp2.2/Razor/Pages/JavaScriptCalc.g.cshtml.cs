#pragma checksum "C:\Users\bob\Documents\Visual Studio 2015\Projects\razor_pages\WebApp\main_portfolio\Pages\JavaScriptCalc.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "45a2e2b5f8e0d56865ece7a6e84a70bcc908ab52"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"45a2e2b5f8e0d56865ece7a6e84a70bcc908ab52", @"/Pages/JavaScriptCalc.cshtml")]
    ...
    public class Pages_JavaScriptCalc : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#line 5 "C:\Users\bob\Documents\Visual Studio 2015\Projects\razor_pages\WebApp\main_portfolio\Pages\JavaScriptCalc.cshtml"
  
    ViewData["Title"] = "Javascript Calculator";

#line default
#line hidden
            BeginContext(115, 7225, true);
            WriteLiteral(@"
...
<script>
    ...
    function btnMulti() {
        ...
        //checks to see if * was press");
            WriteLiteral(@"ed when the display is blank
        if (display == """") {
            //sets default value
            display = ""0*""
    ...
    function btnAdd() {
        //gets value of current display
        va");
            WriteLiteral(@"r display = document.getElementById(""display"").value
        //checks to see if - was pressed when the display is blank
        if (display == """") {
            //sets new  default value
            display = ""0+""
    ...
    function btnDiv() {
        /");
            WriteLiteral(@"/gets value of current display
        var display = document.getElementById(""display"").value
        //checks to see if - was pressed when the display is blank
        if (display == """") {
            //sets new  default value
...
<div id=""containment"">
    ...
    <div id=""draggable"" class=""ui-widget-content"" data-toggle=""popover"" data-placement=""top""");
            WriteLiteral(" data-content=\"DRAG ME!!\" data-trigger=\"hover\">\r\n        ");
            EndContext();
            BeginContext(7340, 2459, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "45a2e2b5f8e0d56865ece7a6e84a70bcc908ab5211129", async() => {
                BeginContext(7346, 2446, true);
                WriteLiteral(@"
            <div>
                <table>
